...
@section('content')
    ...
    <div class="request-list-page">
        <div class="request-list-container">
            ...
            <nav class="request-list-tabs" aria-label="申請一覧の表示切り替え">
                <ul class="request-list-tabs-list" role="tablist">
                    <li class="request-list-tabs-item" role="presentation">
                        <a
                    ...
                    <li class="request-list-tabs-item" role="presentation">
                        <a
                            ...
                            role="tab"
                            aria-selected="{{ $currentTab === 'approved' ? 'true' : 'false' }}"
                        >
                            承認済み
                        </a>
                    </li>
